    ...
    <div className='relative text-white text-[20px] w-full  max-w-[1360px] mx-auto'>
          <Carousel
              ...
              renderArrowPrev={(clickHandler, hasPrev) => (
                  <div
                      className="z-10 absolute right-[31px] md:right-[51px] bottom-0 w-[30px] md:w-[50px] h-[30px] md:h-[50px] bg-black flex items-center justify-center cursor-pointer hover:opacity-90"
              ...
              renderArrowNext={(clickHandler, hasPrev) => (
                  <div
                      className="z-10 absolute right-0 bottom-0 w-[30px] md:w-[50px] h-[30px] md:h-[50px] bg-black flex items-center justify-center cursor-pointer hover:opacity-90"
                      onClick={clickHandler}
                  >
