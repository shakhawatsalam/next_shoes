                        ...
                        <div className="p-5 my-5 bg-black/[0.05]">
                            <div className="flex justify-between">
                              <div className="uppercase text-md md:text-lg font-medium text-black">SubTotal</div>  
                                <div className="text-md md:text-lg font-medium text-black">$133.58</div>  
                            </div>
                            <div className="test-sm md:text-md py-5 border-t mt-5">The subtotal reflects the total price of
